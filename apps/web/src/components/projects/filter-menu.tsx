...
/**
 * The project filter menu. It contains the filter options for Project.
 * @returns The project filter menu component.
 */
export default function ProjectFilterMenu(): JSX.Element {
  ...
  const handleValueSelect = (currentValue: string) => {
    ...
    // Set the filter
    setFilter(selectedFilter, 'in', [currentValue])
